    ...
    for row in body["data"]:
        ...
        for language in row[2]:
            try:
                ...
                text_list.append({"language": language, "translated_text": translated_text, "status": 'success'})
            except Exception as e:
                print(e);
                translate_text = "ERROR"
                # status code of 400 implies an error
                status_code = 400
                text_list.append({"language": language, "text_error": row[1], "status": 'fail', "error_message": e})
...
if __name__ == '__main__':
    event = {"body": {
                "data": [
                    [0, "Hello", ["es", "fr"]],
                    [1, "All other supported data types are serialized as JSON strings." , ["es", "fr"]],
                    [2, "Examples of extracting data are included in the documentation for creating a remote service on each platform", ["es", "fr"]]
                ]
            }}
